package com.santistebanostos_examen02.service.impl;
...
import com.santistebanostos_examen02.exceptions.GeneralServiceException;
import com.santistebanostos_examen02.exceptions.NoDataFoundException;
import com.santistebanostos_examen02.exceptions.ValidateServiceException;
import com.santistebanostos_examen02.repository.UsuarioRepository;
import com.santistebanostos_examen02.service.UsuarioService;
import com.santistebanostos_examen02.validators.UsuarioValidator;
...
public class UsuarioServiceImpl implements UsuarioService {
	...
	public LoginResponseDTO login(LoginRequestDTO request) {
		try {
			...
			if(!encoder.matches(request.getPassword(), usuario.getPassword()) || !usuario.getActivo()) throw new ValidateServiceException("Usuario o Password Incorrectos");
